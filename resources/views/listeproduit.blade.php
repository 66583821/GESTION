...
<body>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <div class="contentAjout">
            ...
            <a href="{{ route('produitliste')}}" class="ml-4 text-sm text-gray-700 underline"><button class="btn btn-primary"> Ajouter un produit</button></a>
        ...
        <table class="table table-dark table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row">1</th>
                    <td>{{ $produit->nom }}</td>
                    <td><img src="{{asset( $produit->prix) }}" style="height: 70px;width:70px"></td>
                    <td>{{ $produit->Photo }}</td>
